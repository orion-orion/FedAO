...
def arg_parse():
    ...
    parser.add_argument('--global_epochs', type=int, default=3, help='number of global training epochs.')
...
def main():
    ...
    clients = [Client(lambda : resnet20(in_channels = data_info["num_channels"], num_classes=data_info["num_classes"]), \
